...
import * as pageHelper from '../common/pageHelper';
...
import { removeNavigationListener, addNavigationListener, awaitNavigation, handlePageUnload } from "../common/navigationHandler";

import * as crawlersDL from "../database/crawlersDL";
import { crawlerStatus } from "../common/enum";

import { ActionDirector } from './actionBuilders/actionDirector';
import { ClickLogicBuilder } from './actionBuilders/clickLogicBuilder';
import { TextInputLogicBuilder } from './actionBuilders/textInputLogicBuilder';


let rootUrl = "";

// TODO: RENAME THIS METHOD
export const init = async (crawler) => {
